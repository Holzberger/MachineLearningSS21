...
\begin{figure}[h]
 ...
 in order to increase senior management focus on our international businesses... 
  ...
  \end{figure}
%
The dataset contains in total 12278 samples, of which 327 duplicates, where 42\% of the samples are spam- and 58\% are non-spam e-mails. %Since there are no missing values, the dataset is perfectly balanced with respect to the target attribute.%
...
\put(-20,0){\includegraphics[width=0.55\linewidth]{spam_desc_count.pdf}}
\put(260,0){\includegraphics[width=0.55\linewidth]{ham_desc_count.pdf}}
%\put(95,190){\textit{a})}
%\put(375,190){\textit{b})}
\end{picture}
...
\begin{figure}[h]
  \begin{tabular}{ | c | c | p{6cm} | c | c | c |}
    ...
    \hline
    E-mail Spam & 10.000  & nominal                          & $N+1$          & text, boolean       & no \\
    \hline
