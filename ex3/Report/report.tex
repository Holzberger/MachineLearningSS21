...
\centering
\SetFigLayout{2}{2}
\subfigure[Confusion matrix Naive Bayes color histogram]{\includegraphics[width=0.45\linewidth]{figures/Cifar/CM__NB_color_hist.pdf}}
\subfigure[Confusion matrix Random forest color histogram]{\includegraphics[width=0.45\linewidth]{figures/Cifar/CM__Rndf_color_hist.pdf}}
\hfill
\subfigure[Confusion matrix single layer perceptron color histogram]{\includegraphics[width=0.45\linewidth]{figures/Cifar/CM__ppn_color_hist.pdf}}
\subfigure[Confusion matrix multi layer perceptron color histogram]{\includegraphics[width=0.45\linewidth]{figures/Cifar/CM__MLP_color_hist.pdf}}
\hfill
...
\centering
\SetFigLayout{2}{2}
\subfigure[Confusion matrix Naive Bayes BOW]{\includegraphics[width=0.45\linewidth]{figures/Cifar/CM__NB_BOW.pdf}}
\subfigure[Confusion matrix Random forest BOW]{\includegraphics[width=0.45\linewidth]{figures/Cifar/CM__Rndf_BOW.pdf}}
\hfill
\subfigure[Confusion matrix single layer perceptron BOW]{\includegraphics[width=0.45\linewidth]{figures/Cifar/CM__ppn_BOW.pdf}}
\subfigure[Confusion matrix multi layer perceptron BOW]{\includegraphics[width=0.45\linewidth]{figures/Cifar/CM__MLP_BOW.pdf}}
\hfill
\caption{Confusion matrices BOW Cifar-10}
\label{CV_Matrices_Cifar_color_hist}
\end{figure}
...
Next we focus our attention on the results for the Tiny ImageNet Dataset.
