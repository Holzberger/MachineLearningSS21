...
\center
  \begin{tabular}{ | l | l | l | l | l |}
    ...
    Amazon  & 0.43			   		 		 & 0.48\cellcolor{gray!25}   	 	   & 0.54\cellcolor{gray!50} \\ \hline
...
\resizebox{\columnwidth}{!}{%
  \begin{tabular}{ | l | l | l | l | l | l | l |}
    ...
    \hline
    Email   & def & 10 & None & def & 0.001     & None \\  
    \hline
    Voting & 13 & 18 & None & $10^{-3}$ & 0.05 & None  \\
	\hline\\
    \end{tabular}%
  	}
    \caption{Best parameterconfiguations for perceptron claasifier with respect to the considered datasets}
    \label{tab_conc1}
  \end{figure}
